...
#
# Usage: ./build-multiarch.sh [tag] [amd64-server] [arm64-server]
...
show_usage() {
    echo "Multi-Architecture Docker Build for OtterEVM Explorer"
    echo ""
    echo "Usage:"
    ...
    echo "  IMAGE_NAME     - Docker image name (default: ghcr.io/otterevm/explorer)"
...
echo -e "${GREEN}╔════════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║   Multi-Architecture Docker Build - OtterEVM Explorer  ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════════╝${NC}"
echo ""
